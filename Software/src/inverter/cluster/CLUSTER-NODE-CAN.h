...
class ClusterNodeCanInverter : public CanInverterProtocol {
 ...
 private:
  ...
  unsigned long previousMillis_frame5 = 0;
  ...
  // v3: master's reported protocol version (0 until first frame received)
  uint8_t last_master_protocol_version = 0;
  ...
  CAN_frame tx_frame5 = {.FD = false, .ext_ID = false, .DLC = 8, .ID = 0, .data = {0}};
};
